...
​
        These are hardcoded into _most_ blockchain protocols
        """
        block = {
            'index': 1,
            'timestamp': 1,
    ...
    def broadcast_new_block(self, block):
        """
        Alert neighbors that a new block has been mined,
        and they should add it to their chain as well
        """
    ...
    if new_block['index'] == old_block['index'] + 1:
        ...
        if new_block['previous_hash'] == blockchain.hash(old_block):
            ...
            if blockchain.valid_proof(block_string, new_block['proof']):
                ...
                # Bad proof, handle here
                pass
        else:
            # Hashes do not match, handle err here
            pass
    else:
